    ...
    return (
        <Layout>
            ...
            spacing={20}>
                ...
                <Link href='#'>
                    <HStack>
                        <Image src= 'https://applywave.com/wp-content/uploads/2020/01/DeAnza.png' w='3em' borderRadius={'10'}/>
                ...
                <Link href='#'>
                    <HStack>
                        <Image src= 'https://pbs.twimg.com/profile_images/1243630920877432834/eHU4fLbr_400x400.jpg' w='3em' borderRadius={'10'}/>
                        <Heading size={'lg'}>College of the Canyons</Heading>
                    </HStack> 
                </Link>
                <Link href='#'>
                    <HStack>
                        <Image src= 'https://huevos-uploads-production.s3-us-west-1.amazonaws.com/uploads/file-c58b5e59-d03b-4e49-9666-fbcfe94136f6-FoothillCollege.jpg' w='3em' borderRadius={'10'}/>
